...
Open the ESW folder as a project in Android Studio.
Ensure you have Android SDK 34 installed and a device with Android 9 (API 28)+ and ARM64 (arm64-v8a) CPU.
Verify the segmentation model:
...
Connect an Android device (USB debugging enabled) or start an ARM64 emulator.
Select the app configuration in Android Studio and click Run.
